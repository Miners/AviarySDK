Pod::Spec.new do |s|
  ...
  s.source              = { :http => 'http://aviarystatic.s3.amazonaws.com/sdk/ios/4.4.0/Aviary-iOS-SDK.zip' }
  s.platform            = :ios, '6.0'
  s.resource            = 'AviarySDK-4.4.0/AviarySDK/AviarySDKResources.bundle'
  s.vendored_frameworks = 'AviarySDK-4.4.0/AviarySDK/AviarySDK.framework'
