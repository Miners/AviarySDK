...
/**
    @returns The name of the product in English. This should match the name
    entered into iTunes Connect for this product.
 */
@property (nonatomic, copy, readonly) NSString *productName;

/**
    @returns The description of the product in English. This should match the
    description entered into iTunes Connect for this product.
 */
@property (nonatomic, copy, readonly) NSString *productDescription;

/**
    @returns The internal product identifier. This key is guaranteed to be
    ...
    to pass your unique identifier to the SDK. See the README for more
    information.
 */
